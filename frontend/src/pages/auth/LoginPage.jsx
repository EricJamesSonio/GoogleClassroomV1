...
const s = {
  ...
  left: { 
    flex:'1', 
    background:'linear-gradient(160deg, #1a1726 0%, #110f1a 60%, #0d0b14 100%)', 
  ...
  right: { 
    ...
    alignItems:'center', 
    justifyContent:'center', 
    padding:'clamp(24px, 5vw, 48px) clamp(16px, 4vw, 44px)',
    width:'100%'
  },
  ...
  devBtn: { 
    ...
    padding:'clamp(6px, 1vw, 9px) clamp(8px, 2vw, 12px)', 
    color:'var(--text3)', 
    fontSize:'clamp(10px, 2vw, 12px)', 
    fontWeight:'500', 
    display:'flex', 
...
// Add responsive CSS to your index.css
const responsiveLoginCSS = `
  /* MOBILE (max-width: 768px) - Hide left panel, show form only */
  ...
  /* TABLET (768px - 1024px) - Show both panels with responsive sizing */
